...
import 'app/shared/network_error.dart';
import 'app_theme.dart';
import 'app/core/values/localization/messages.dart';
import 'routes/app_pages.dart';

class NourishDriverApp extends StatefulWidget {
  const NourishDriverApp({Key? key}) : super(key: key);

  @override
  _NourishDriverAppState createState() => _NourishDriverAppState();
}

class _NourishDriverAppState extends State<NourishDriverApp> {
